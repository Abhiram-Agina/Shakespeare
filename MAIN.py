...
~ Abhiram Agina
''')
st.write('Note: these images are generated by AI, DALL-E. Refer: https://openai.com/product/dall-e-2')
...
cols[2].image('images/row_2_col_2.png', caption='Computational Linguistics', use_column_width=True)
cols[2].markdown("[Computational Linguistics](https://abhiram-agina-linguistics-linguistics-oob09x.streamlit.app/)")
